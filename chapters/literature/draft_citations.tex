...
\cite{bukh1992art}
%%%%%%%%%%%%%%%%%
% TODO : REPHRASE THIS other wise it will be plagiarism
...
\begin{figure}
    \center{\includegraphics[width=1\linewidth]{images/virtualization_techniques}}
...
\begin{figure}
    \center{\includegraphics[width=.5\linewidth]{images/docker_vs_vm_energy_paper/idle_energy}}
