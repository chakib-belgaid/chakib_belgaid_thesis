...
\begin{itemize}
    ...
    \item  \em{Precision}: to eliminate extra hazards and get a more representative measurement.
\end{itemize}

We believe that precision can be extracted from these criteria by combining the first two results. Therefore, we will focus more on the first three criteria later on.
...
% we will  starting with the GRPC framework and a set of Web Frameworks.
% Finally, we will discuss the impact of the execution environment on the energy consumption of two of the most famous programming languages Java and Python, and present how tunning the Virtual Machine can reduce energy consumption.
