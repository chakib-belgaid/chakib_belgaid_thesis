...
\subsubsection{definition of the JVM}
\begin{figure}%[ht]
    \centering
...
\subsection{Experimental Protocol}\label{sec:meth}
...
\subsubsection{Measurement Contexts}
...
\subsection{Experiments \& Results}\label{sec:exp}
\subsubsection{Energy Impact of JVM Distributions}
...
\subsubsection{Energy Impact of JVM Settings}
...
\subsection{Tools and contributions}
