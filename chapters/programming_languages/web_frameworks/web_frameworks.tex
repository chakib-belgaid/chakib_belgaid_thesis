...
As we see in the table below, some of the frameworks worked on certain conditons while they failed on other tests such as % TODO : add one framework. 
...
%TODO add number of clients for each type of workload 
