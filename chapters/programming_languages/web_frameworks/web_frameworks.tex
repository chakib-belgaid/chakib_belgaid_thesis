...
\begin{enumerate}
    ...
    \item Finally the stress state . After 128 parallel clients most of the frameworks consumes had a stable power consumption regardless of the number of clients.this is due to the fact that database server reached its maximum capacity. % TODO to verify avec plain text and json 
\end{enumerate}
\begin{figure}[hbt]
    \centering
...
%TODO : add notations to the graph using plotly instead of previews
\begin{figure}[hbt]
    % \centering
