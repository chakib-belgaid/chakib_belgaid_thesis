...
\begin{itemize}
    \item is there a dominant  programing languages when it comes to , energy consumption and latency ?
...
the best example, if we compare the average energy consumption for each programming language, this wont reflect in reality specially when we have two frameworks on the opposite sides of the spectrum.
