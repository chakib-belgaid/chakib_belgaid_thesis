...
%TODO : add a table with a single scenarios / check the website 
%TODO : add notations to the graph using plotly instead of preview s
\begin{figure}[hbt]
    % \centering
...
%     \centering
%     \includegraphics[width=
%         \columnwidth]{imgs/histogram_db}
%     \caption{total request vs average power consumption for the Single query test ( size of circles represents the number of clients)}
%     \label{fig:power_request_db}
% \end{figure}
