...
Figure~\ref{scatter_db} demonstrates a such behavior. As one can notice. for each level we have a linear clusturing. 



Another interesting result is the relationship between 
