...
First we will start with a histogram of average power consumption. Figure~\ref{fig:av_power_db} presents the average power consumption based on the number of parallel clients.
One can notice
% \begin{figure}[hbt]
%     \centering
