...
Moreover, when increasing the size of the collection, the map with lambda functions tends to consume less energy than the predetermined one.
...
\paragraph*{subsubsection}{Synthesis}
