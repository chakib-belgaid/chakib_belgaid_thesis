...
First, we study the energy behavior of Python in two application contexts: machine learning (cf. \Cref{sec:webdev}) web applications (cf. \Cref{sec:ml}).
...
% TODO : Missing analysis of the results
