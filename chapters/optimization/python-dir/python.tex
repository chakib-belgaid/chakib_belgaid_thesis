...
performance
- sequentiel took less time then mulit threading
- 4 process was the optimal one
-- for cpu power the multi threading reached 13 watts whule the 4 process multiprocessing was 42 watts
-- for global energy  the sequentiel one took the most, then the multithreading after that the muli processing , while keeping the 4 process always the optimial one





Additionally, \Cref{fig:python_multiprocessing} reports on the energy consumption of Python applications.
