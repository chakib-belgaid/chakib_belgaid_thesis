...
In the Chapter , %% reference the work of intern from lyon  
we discuss this behavior of the scheduler more deeply and we assess that it is not due to Python, but is a more generic behavior. %% maybe even this graph should go there 
