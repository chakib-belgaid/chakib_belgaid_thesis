...
\end{table*}
Fighre \ref{ig:jvm benchmarks-classification}  highligts the scope of each benchmark from the test suit.
\begin{figure*}%[ht]
    \centering
    \includegraphics[width=\linewidth]{imgs/jvm_benchmarks}
    \caption{Target scope of Dacapo and Renaissance benchmarks}
...
\note{The jvm must be provided by sdkman\footnote{\url{https://sdkman.io/}}}
