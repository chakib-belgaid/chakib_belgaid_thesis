...
While some scientists are trying to find an alternative green source to generate energy. others focus on reducing it's%whose?
consumption. In computer science we are concerned with the ladder solution %reference.
Therefore most of the works are done on tunning the software and the hardware in ordrer to have a more efficient way use this energy. %more efficient way of producing programs from electricity? 
