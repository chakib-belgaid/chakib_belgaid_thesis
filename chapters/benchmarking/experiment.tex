...
The second criterion is whether or not the workload is \textbf{representative}. As stated in the challenges, a workload must be representative or the experiment would be inconsistent~\cite{stephen_evaluate_2012}.
