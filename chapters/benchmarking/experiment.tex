...
\section{Improving accuracy by Taming the energy variation}\label{sec:taming-the-energy-variation}

While the previous section aimed to ensure the reproducibility of our software energy consumption experiments, this section will provide a collection of tips and tools to help you increase the accuracy of these experiments.
...
In this section we will try to answer the following Research questions.
\begin{description}
...
The table below~\ref{table:g5k}, presents a description of the four cluster that have been chosen for our experiments.
...
The second criterion is whether or not the workload is \textbf{representative}. As stated in the challenges, a workload must represent the production enviromenet or the experiment would be inconsistent~\cite{stephen_evaluate_2012}.
...
Our metric for the accuracy of the test is the Standard deviation aka \textbf{STD} of the energy consumption. Therefore whether the tests consumes more or less energy is out of our scope.
