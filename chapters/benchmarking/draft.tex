...
Because the goal of this thesis is to investigate various possibilities for improving the energy consumption of software programs, this chapter will be focusing on how to conduct effective experiments when comparing the energy consumption of softwares.
We will carry out substantial empirical investigation. This chapter discusses the tools needed to do a successful experiment measuring the energy consumption of software programs.
...
Instead of only presenting the four primary aspects of their guidelines, which are 
