...
Most of the approaches were to use the carbon emission, such as~\cite{patterson2021carbon} or ecograder,\link{https://ecograder.com/} as a pivot metrics to quantify the environmental cost of software.
