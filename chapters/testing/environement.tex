...
Based on the studies of \cite{eddie_antonio_santos_how_nodate}, who analysed the impact of adding the docker layer on the energy consumption.
...
\begin{figure}
    ...
    \caption{energy consumption of Idle system with and without docker \cite{eddie_antonio_santos_how_nodate}}\label{fig:docker_idle}
\end{figure}
...
\begin{figure}
    ...
    \caption{execution time and energy consumption of Redis  with and without docker \cite{eddie_antonio_santos_how_nodate}}\label{fig:docker_reddis}
\end{figure}
