...
Second creterion is \textbf{representativeness} : as menstionned in the challenges, a workload has to be representative otherwise the experiment would be inconsistent \cite{evaluate_Collaboratory}.
