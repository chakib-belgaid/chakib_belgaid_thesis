...
\crest{
    \centering
    \includegraphics[width=.2\textwidth, keepaspectratio]{Figs/logodavidosn}\,
    \includegraphics[width=.2\textwidth]{Figs/logo-inria}\,
    \includegraphics[width=.2\textwidth,trim={0 3em 0 0 }]{Figs/logo-univ-lille}\,
    \includegraphics[width=.2\textwidth]{Figs/logo-cristal}\,
}
